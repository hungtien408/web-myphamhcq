<%@ Page Title="" Language="C#" MasterPageFile="~/site-sub.master" AutoEventWireup="true" CodeFile="thuong-hieu-san-pham.aspx.cs" Inherits="my_pham" %>
            ...
            <div class="pro-cate trangdiem-cate">
                ...
                <asp:ObjectDataSource ID="odsProduct" runat="server"
                    ...
                    <SelectParameters>
                        ...
                        <asp:QueryStringParameter QueryStringField="th" Name="ManufacturerID" Type="String" />
