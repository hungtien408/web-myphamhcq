...
public partial class thong_tin_nhan_hang : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            Page.Title = "SuriCosmetics";
            var meta = new HtmlMeta() { Name = "description", Content = "SuriCosmetics" };
        ...
        if (IsValid)
        {
            ...
            if (dtCart != null)
            {
                ...
                if (rbtMoney.Checked == true)
                {
                    ...
                    Common.SendMail("smtp.gmail.com", 587, "webmastersendmail0401@gmail.com", "web123master", txtEmail, "hungtien408@gmail.com", "Đặt Hàng Suri Cosmetics", Body, true);
                    /////////////////////////////////////////////////////////////////////////////////
                    //txtFullName.Text = "";
                    //txtPhone.Text = "";
                    //txtEmail.Text = "";
