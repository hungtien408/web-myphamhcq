...
public partial class site : System.Web.UI.MasterPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            if (!string.IsNullOrEmpty(Request.QueryString["pci"]))
            {
                ...
                hdnMenu.Value = progressTitle(dv2[0]["ProductCategoryName"].ToString()) + "-pci-" + dv2[0]["ProductCategoryID"].ToString() + ".aspx";
            }
    ...
    protected void btnRegister_Click(object sender, EventArgs e)
    {
        if (Page.IsValid && RadCaptcha1.IsValid)
        {
            ...
            if (!bError)
            {
                ...
                Body += "<p>Mọi thắc mắc, xin vui lòng liên hệ với chúng tôi qua email: <a href='mailto:hotro@suricosmetics.com.vn'>hotro@suricosmetics.com.vn</a> /If you have any enquiries, please email us on <a href='mailto:hotro@suricosmetics.com.vn'>hotro@suricosmetics.com.vn</a></p>";
    ...
    protected void lnkLoginGmail_Click(object sender, EventArgs e)
    {
