                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadTextBox ID="txtDescription" runat="server" Text='<%# Bind("Description") %>'
                                                              Width="500px" EmptyMessage="Website" TextMode="MultiLine">
                                                            </asp:RadTextBox>
                                                        </td>
                                                    </tr>
                                                    <tr class="invisible">
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="ProductSelectAll"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="txtSearchPriceTo" Name="PriceTo" PropertyName="Text"
                Type="String" />
            <asp:ControlParameter DefaultValue="9" ControlID="ddlSearchCategory" Name="CategoryID" PropertyName="SelectedValue"
                Type="String" />
